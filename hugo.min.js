...
function dynamicAlloc(a){var b=HEAP32[DYNAMICTOP_PTR>>2];a=b+a+15&-16;HEAP32[DYNAMICTOP_PTR>>2]=a;return a>=TOTAL_MEMORY&&!enlargeMemory()?(HEAP32[DYNAMICTOP_PTR>>2]=b,0):b}function alignMemory(a,b){b||(b=STACK_ALIGN);return Math.ceil(a/b)*b}
function getNativeTypeSize(a){switch(a){case "i1":case "i8":return 1;case "i16":return 2;case "i32":return 4;case "i64":return 8;case "float":return 4;case "double":return 8;default:return"*"===a[a.length-1]?4:"i"===a[0]?(a=parseInt(a.substr(1)),assert(0===a%8),a/8):0}}function warnOnce(a){warnOnce.shown||(warnOnce.shown={});warnOnce.shown[a]||(warnOnce.shown[a]=1,err(a))}
var asm2wasmImports={"f64-rem":function(a,b){return a%b},"debugger":function(){debugger}},jsCallStartIndex=1,functionPointers=[],funcWrappers={};function dynCall(a,b,c){return c&&c.length?Module["dynCall_"+a].apply(null,[b].concat(c)):Module["dynCall_"+a].call(null,b)}var GLOBAL_BASE=1024,ABORT=!1,EXITSTATUS=0;function assert(a,b){a||abort("Assertion failed: "+b)}function getCFunc(a){var b=Module["_"+a];assert(b,"Cannot call unknown function "+a+", make sure it is exported");return b}
var JSfuncs={stackSave:function(){stackSave()},stackRestore:function(){stackRestore()},arrayToC:function(a){var b=stackAlloc(a.length);writeArrayToMemory(a,b);return b},stringToC:function(a){var b=0;if(null!==a&&void 0!==a&&0!==a){var c=(a.length<<2)+1;b=stackAlloc(c);stringToUTF8(a,b,c)}return b}},toC={string:JSfuncs.stringToC,array:JSfuncs.arrayToC};
function ccall(a,b,c,d,e){e=getCFunc(a);var f=[];a=0;if(d)for(var g=0;g<d.length;g++){var h=toC[c[g]];h?(0===a&&(a=stackSave()),f[g]=h(d[g])):f[g]=d[g]}c=e.apply(null,f);c="string"===b?Pointer_stringify(c):"boolean"===b?!!c:c;0!==a&&stackRestore(a);return c}
...
function postRun(){if(Module.postRun)for("function"==typeof Module.postRun&&(Module.postRun=[Module.postRun]);Module.postRun.length;)addOnPostRun(Module.postRun.shift());callRuntimeCallbacks(__ATPOSTRUN__)}function addOnPreRun(a){__ATPRERUN__.unshift(a)}function addOnPostRun(a){__ATPOSTRUN__.unshift(a)}function writeArrayToMemory(a,b){HEAP8.set(a,b)}function writeAsciiToMemory(a,b,c){for(var d=0;d<a.length;++d)HEAP8[b++>>0]=a.charCodeAt(d);c||(HEAP8[b>>0]=0)}
var Math_abs=Math.abs,Math_ceil=Math.ceil,Math_floor=Math.floor,Math_min=Math.min,runDependencies=0,runDependencyWatcher=null,dependenciesFulfilled=null;function getUniqueRunDependency(a){return a}function addRunDependency(a){runDependencies++;Module.monitorRunDependencies&&Module.monitorRunDependencies(runDependencies)}
function removeRunDependency(a){runDependencies--;Module.monitorRunDependencies&&Module.monitorRunDependencies(runDependencies);0==runDependencies&&(null!==runDependencyWatcher&&(clearInterval(runDependencyWatcher),runDependencyWatcher=null),dependenciesFulfilled&&(a=dependenciesFulfilled,dependenciesFulfilled=null,a()))}Module.preloadedImages={};Module.preloadedAudios={};var dataURIPrefix="data:application/octet-stream;base64,";
function isDataURI(a){return String.prototype.startsWith?a.startsWith(dataURIPrefix):0===a.indexOf(dataURIPrefix)}
...
Module.wasmMaxTableSize;b.table="object"===typeof WebAssembly&&"function"===typeof WebAssembly.Table?void 0!==f?new WebAssembly.Table({initial:e,maximum:f,element:"anyfunc"}):new WebAssembly.Table({initial:e,element:"anyfunc"}):Array(e);Module.wasmTable=b.table}b.memoryBase||(b.memoryBase=Module.STATIC_BASE);b.tableBase||(b.tableBase=0);a=c(a,b,d);assert(a,"no binaryen method succeeded.");return a}}integrateWasmJS();STATIC_BASE=GLOBAL_BASE;STATICTOP=STATIC_BASE+1699520;__ATINIT__.push();
var STATIC_BUMP=1699520;Module.STATIC_BASE=STATIC_BASE;Module.STATIC_BUMP=STATIC_BUMP;var tempDoublePtr=STATICTOP;STATICTOP+=16;function ___lock(){}
...
arguments)},stackRestore=Module.stackRestore=function(){return Module.asm.stackRestore.apply(null,arguments)},stackSave=Module.stackSave=function(){return Module.asm.stackSave.apply(null,arguments)},dynCall_ii=Module.dynCall_ii=function(){return Module.asm.dynCall_ii.apply(null,arguments)},dynCall_iiii=Module.dynCall_iiii=function(){return Module.asm.dynCall_iiii.apply(null,arguments)};Module.asm=asm;
function ExitStatus(a){this.name="ExitStatus";this.message="Program terminated with exit("+a+")";this.status=a}ExitStatus.prototype=Error();ExitStatus.prototype.constructor=ExitStatus;var initialStackTop;dependenciesFulfilled=function runCaller(){Module.calledRun||run();Module.calledRun||(dependenciesFulfilled=runCaller)};
